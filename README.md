...
# :microscope: LCI Microscopy Course: Image Analysis Workshop

Welcome to the image analysis workshop organized by the [Bioimage Informatics facility](https://www.scilifelab.se/units/bioimage-informatics/) & the [Live Cell Imaging facility](https://ki.se/en/bionut/live-cell-imaging-core-facility-lci) for the LCI Microscopy course! During this workshop, you will:
